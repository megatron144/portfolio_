            ...
            <div className={styles.techIcons}>
              ...
              <span title="Node.js">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-label="Node.js">
                  <path d="M12 2l9 5.2v10.4l-9 5.2-9-5.2V7.2L12 2z" stroke="#22c55e" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M12 6.5l5.2 3v6l-5.2 3-5.2-3v-6l5.2-3z" fill="rgba(34, 197, 94, 0.18)" stroke="#22c55e" strokeWidth="1.2"/>
                </svg>
              </span>
